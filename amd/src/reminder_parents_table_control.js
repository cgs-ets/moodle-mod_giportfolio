        ...
        if (t) {
            ...
            Array.from(t.rows).forEach((tr) => {
                ...
                if (ids.includes(user)) {
                    jQuery(tr.cells[4]).children().replaceWith('<span class="giportfolio-legend" title="Reminder sent"><i class="fa">&#xf2b7;</i></span>'); // Column 3 has the status.
                    jQuery(tr.cells[5]).children().replaceWith(date);
