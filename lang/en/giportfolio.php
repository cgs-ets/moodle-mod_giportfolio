...
$string['allusers'] = 'All {$a}s'; // Students.
...
$string['errorpath'] = 'It seems you do not have permission to access this portfolio.';
...
$string['hideshared'] = 'Hide other {$a}s\' contributions'; // Students.\'
...
$string['share'] = 'Share with other {$a}s'; // Students.
$string['show'] = 'Show your contribution to faculty only, not students';
$string['showshared'] = 'Show other {$a}s\' contributions'; // Students.'
...
$string['studentgiportfolios'] = '<h2>{$a} portfolios </h2>'; // Students.
...
$string['tutor'] = 'Tutor';
$string['generalreport'] = 'Contributions overview';
$string['generalreport_title'] = 'Shows all participants with their overall contribution status, supervisor and last access';
$string['contributionreport'] = 'Contributions by chapter';
$string['contributionreport_title'] = 'Shows whether each participant has contributed to each chapter for a selected year';
$string['supervisor'] = 'Supervisor';
$string['year'] = 'Year';
$string['nochaptersinyear'] = 'No chapters found for the selected year.';
$string['contributed'] = 'Yes';
$string['notcontributed'] = 'No';
