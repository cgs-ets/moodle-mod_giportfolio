...
$string['parentuserwithnocontribwarning'] = 'This section sends emails to the student\'s parent(s). To send remindes to students go to <a href="{$a}">Student contribution reminder</a>';
