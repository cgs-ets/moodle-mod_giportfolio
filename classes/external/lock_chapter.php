...
trait lock_chapter {
    ...
    public static function lock_chapter_parameters() {
        return new external_function_parameters(
            array(
                'chapter' => new external_value(PARAM_RAW, 'chapter to lock'),
     ...
     * @return array
     */
    public static function lock_chapter($chapter) {
        global $COURSE, $DB;
        ...
        self::validate_parameters(
            self::lock_chapter_parameters(),
            array(
                'chapter' => $chapter,
            )
        );

        $chapterid = giportfolio_lock_chapter(json_decode($chapter));
     ...
     *
     */
    public static function lock_chapter_returns() {
