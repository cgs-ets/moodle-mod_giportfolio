...
/**
 * Contributions report table filterset.
 *
...
class contributions_filterset extends filterset {

    /**
     * Get the required filters.
     *
     * courseid, cmid and giportfolioid scope the query; year drives the chapter columns.
     *
     * @return array
     */
