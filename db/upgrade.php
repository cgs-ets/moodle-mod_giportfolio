...
function xmldb_giportfolio_upgrade($oldversion) {
    ...
    if ($oldversion < 2020032200) {
        ...
        $teacher_field = new xmldb_field('teacherid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0', 'mentorid');
    ...
    if ($oldversion < 2021080600) {
        ...
        // Define table giportfolio_last_seen to be created.
        $table = new xmldb_table('giportfolio_last_seen');

        // Adding fields to table giportfolio_last_seen.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('giportfolioid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('chapterid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        ...
        // Conditionally launch create table for giportfolio_last_seen.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
